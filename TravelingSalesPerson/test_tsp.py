...
from tsp_solve import greedy_tour, dfs, branch_and_bound, branch_and_bound_smart, State
...
def test_hw_branch_and_bound():
    ...
    assert stats[0].tour == [0, 2, 3, 1]
    assert stats[0].score == 15
...
#
#     timer = Timer(10)
#     bandb_stats = branch_and_bound(edges, timer)
#     time = timer.time()
#     print(bandb_stats[-1].score)
#
#     timer = Timer(10)
#     stats = branch_and_bound_smart(edges, timer)
#     assert_valid_tours(edges, stats)
